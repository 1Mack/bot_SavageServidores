...
exports.EmailOrderReceived = function (sale) {
  return `
  <!DOCTYPE html
                              ...
                              <tr>
                                <td align="center" style="padding:0;Margin:0">
                                  <h1
                                    ...
                                    Seu Pedido está quase completo!</h1>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="padding:0;Margin:0;padding-top:5px;padding-bottom:5px">
                                  <p
                                    ...
                                    Prezado(a) ${sale.client_name.split(' ')[0]}, queremos expressar nossa sincera gratidão pela realização do seu pedido em nosso servidor. Ao
                                    optar por adquirir conosco, você não apenas enriquece a sua experiência, mas também faz
                                    
                                    uma valiosa contribuição à comunidade.
                                    
                                    Agradecemos profundamente pela sua confiança e escolha, e estamos ansiosos para
                                    
                                    proporcionar a você uma jornada excepcional em nossa plataforma.
                                    </p>
                                </td>
                              </tr>
                            </table>
                                  ...
                                  <table cellpadding="0" cellspacing="0" width="100%"
                                    ...
                                    <tr>
                                      <td align="center"
                                        ...
                                        <a target="_blank" href="https://viewstripo.email"
                                          style="mso-line-height-rule:exactly;text-decoration:underline;color:#926B4A;font-size:14px"><img
                                            src="https://xphfzz.stripocdn.email/content/guids/CABINET_455a2507bd277c27cf7436f66c6b427c/images/85851620374838300.png"
                                            alt=""
                                            style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"
                                            width="30"></a>
                                      </td>
                                    ...
                                    <tr>
                                      <td align="center"
                                        ...
                                        <p
                                          style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px">
                                          Pedido Entregue<br>Aguardando Envio</p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
                                    ...
                                    <tr>
                                      <td align="right" class="es-m-p0t es-m-p0b"
                                        ...
                                        <p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#666666;font-size:14px"
                                          class="p_description">Aguardando Envio</p>
                                      </td>
                                    </tr>
                                  </table>
                                </td>
