...
exports.compra_Handle = async function (m, user, msg) {
  ...
  let FirstAwnser = await m.awaitMessageComponent({ filter, componentType: ComponentType.SelectMenu, time: 45000 })
    .then(async (response) => {
  ...
  if (FirstAwnser !== 'outros') {
    ...
    FirstAwnser = await m.awaitMessageComponent({ filter, componentType: ComponentType.SelectMenu, time: 45000 })
      .then(async (response) => {
  ...
  const SecondAwnser = await m.awaitMessageComponent({ filter, componentType: ComponentType.SelectMenu, time: 45000 })
    .then(async (response) => {
