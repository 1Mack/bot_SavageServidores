...
module.exports = {
    ...
    options: [{ name: 'servidor', type: 3, description: 'Escolher um Servidor para o Set', required: true, choices: serversInfos.map(m => { return { name: m.name, value: m.serverNumber.toString() } }) },
    ...
    async execute(client, interaction) {
        ...
        let logStaffFind = new MessageEmbed().addFields(
