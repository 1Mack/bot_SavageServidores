...
module.exports = {
  ...
  options: [
    { name: 'quantidade', type: ApplicationCommandOptionType.Integer, description: 'Quantidade de msgs a serem excluídas (>1<99)', required: true, choices: null },
    { name: 'botmsg', type: ApplicationCommandOptionType.Boolean, description: 'Limpar mensagem de bot também?', required: false, choices: null },
  ],
