...
module.exports = {
    ...
    cooldown: 0,
    permissions: [{id: '892029388135206922', type: 1, permission: true}, {id: '711022747081506826', type: 1, permission: true}], //Perm Form
    async execute(client, interaction) {
        ...
        for (let x in canal) {
            ...
            let formMessage2 = new MessageEmbed().setColor('#0099ff').setTitle(``);
            let formMessage3 = new MessageEmbed().setColor('#0099ff').setTitle(``);
            ...
            await canalCheck
                .awaitMessageComponent({ filter, componentType: 'BUTTON', time: 1000000})
                .then(async (collected) => {
                    ...
                    if (collected.customId == 'next') {
                        ...
                        guild.channels.cache.get('880985449198407683').send({embeds: [logInfos(fetchUser, result)]})
                    } else {
                        ...
                        client.channels.cache.get('848364797975068682').send({embeds: [LogAprovadoChannel(interaction.user, fetchUser, result)]});
