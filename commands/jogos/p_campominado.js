const { ActionRowBuilder, ButtonBuilder, EmbedBuilder, ApplicationCommandOptionType, ComponentType, ButtonStyle } = require('discord.js');
...
module.exports = {
  ...
  options: [{ name: 'bombs', type: ApplicationCommandOptionType.Integer, description: 'Total de Bombas', required: true, choices: [{ name: '1 (0.001x)', value: 1 }, { name: '3 (0.003x)', value: 3 }, { name: '5 (0.005x)', value: 5 }, { name: '10 (0.01x)', value: 10 }] },
